...
{{$posts->links()}}
     <div class="my-4 py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6 lg:py-0">
    ...
    @forelse ($posts as $post )
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <h2 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="/posts/{{$post['slug']}}" class="hover:underline">{{$post['title']}}</a></h2>
    ...
    @empty
    <p class="font-semiblod text-xl my-4">Article not found !</p>
    <a href="/posts" class="block text-blue-600 honver:underline">&laquo; Back to all posts</a>
